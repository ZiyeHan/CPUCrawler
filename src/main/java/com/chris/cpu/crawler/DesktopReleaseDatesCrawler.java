...
public class DesktopReleaseDatesCrawler extends AbstractReleaseDateCrawler{

    @Override
    protected void openPage(int year) {
        driver.get(PageConstants.DATE_DESKTOP + "_(" + year + ").html");
    }

    @Override
    protected HashMap<String, String> crawlTarget(int year, HashMap<String, String> crawlResult) {
        System.out.println("Crawling desktop release date from year " + year + "...");
